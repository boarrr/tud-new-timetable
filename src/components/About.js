...
const officialTimetableLink = "https://timetables.tudublin.ie";
			...
			<div className="inner-body">
				<header>
					<div className="header-wrapper">
						<div className="left-header">
							<Link to="/" className="back-button" aria-label="Go back to timetable">
								<BackArrowIcon alt="Back" width={arrowSize} height={arrowSize} />
							</Link>
							<h2>About</h2>
						</div>
						<ThemeToggle />
				...
				<main>
					<div className="about-text-container">
						...
						<p>
							Link to official timetable:{" "}
							<a href={officialTimetableLink}>{officialTimetableLink}</a>
						</p>
